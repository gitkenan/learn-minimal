// components/icons/AmbitionIcon.jsx

export default function AmbitionIcon({ className }) {
    return (
      <svg
        className={`svg-hover-effect ${className}`}
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512" // Adjust the viewBox as per your SVG
        data-aos="zoom-in"
        data-aos-delay="400"
        aria-labelledby="ambitionTitle"
        role="img"
      >
        <title id="ambitionTitle">Ambition Icon</title>
        <g>
